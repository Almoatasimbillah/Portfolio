...
window.I18N = {
  en: {
    ...
    'phase2.body':     'Where decisions happen. Years of choices — IT helpdesk floors to engineering. ISTQB methodologies, OWASP discipline.',
    ...
    'about.body2':     'In the field since 2019 — from IT helpdesk floors to engineering. ISTQB methodologies, OWASP discipline, hands-on lab practice. Completed the DEPI software engineering programme in May 2026, and passed the ISTQB Foundation exam.',
  ...
  ar: {
    ...
    'phase2.body':     'حيث تُتَّخَذ القرارات. سنوات من الخيارات — من الدعم الفنّي حتى الهندسة. منهجيات ISTQB، انضباط OWASP.',
    ...
    'about.body2':     'في الميدان منذ ٢٠١٩ — من قاعات الدعم الفنّي حتى الهندسة. منهجيات ISTQB، انضباط OWASP، ممارسة عملية. أنهيتُ برنامج DEPI في مايو ٢٠٢٦، واجتزتُ امتحان ISTQB Foundation.',
